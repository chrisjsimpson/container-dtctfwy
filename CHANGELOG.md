...
- stripp slashes ([@chrisjsimpson](https://github.com/chrisjsimpson))
...
- #1 config upload folder ([@chrisjsimpson](https://github.com/chrisjsimpson))
...
- absolute uploads dir ([@chrisjsimpson](https://github.com/chrisjsimpson))
